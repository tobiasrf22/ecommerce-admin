                ...
                <div className='flex gap-1 mb-2'>
                    ...
                    <select className='mb-0 capitalize'
                        ...
                        <option className='capitalize' value=''>No parent category</option>
                            <option className='capitalize' value="">category.name</option>
                    </select>
                </div>
                <div className='mb-2 '>
                    <div className='mb-2'>
                        <label className='block'>Properties</label>
                        <button type='button' className='btn-default text-sm'>Add new property</button>
                    </div>
                        <div className='flex gap-1 mb-2'>
                            <input
                                className='mb-0 '
